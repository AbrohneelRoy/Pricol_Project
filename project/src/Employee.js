...
const Employee = () => {
  const columns = [
    ...
    'Customer', 'Phase/Stage','SW Start Date','SW End Date', 'SW Initial Test Start Date', 'SW Initial Test End Date', 
    'SW DV Start Date', 'SW DV End Date', 'SW Customer Release Date', 'SW Windchill Release Date',
