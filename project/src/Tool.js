...
const Tool = () => {
  const columns = [
    'Tool Name', 'Tool Serial Name','Project PIF', 'Project Name', 'Emp Code', 'Human Resources',
     'Customer', 'Phase/Stage','SW Start Date','SW End Date', 'SW Initial Test Start Date', 'SW Initial Test End Date', 'SW DV Start Date', 'SW DV End Date', 'SW Customer Release Date', 'SW Windchill Release Date',
     'D & D Efforts Actual (PHs)', 'D & D Efforts Planned (PHs)',
          ...
          {showAddForm && (
            <div className={styles['projects-form']}>
              ...
              <input
                ...
                className={styles['projects-input']}
              />
              <button className={styles['projects-button']} onClick={handleSubmit}>
